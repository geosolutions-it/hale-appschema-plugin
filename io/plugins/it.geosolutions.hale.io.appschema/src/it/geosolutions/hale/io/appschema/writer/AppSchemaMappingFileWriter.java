...
import static it.geosolutions.hale.io.appschema.AppSchemaIO.DATASTORE_FILE;
import static it.geosolutions.hale.io.appschema.AppSchemaIO.FEATURETYPE_FILE;
import static it.geosolutions.hale.io.appschema.AppSchemaIO.LAYER_FILE;
import static it.geosolutions.hale.io.appschema.AppSchemaIO.NAMESPACE_FILE;
import static it.geosolutions.hale.io.appschema.AppSchemaIO.WORKSPACE_FILE;
import it.geosolutions.hale.io.appschema.AppSchemaIO;
import it.geosolutions.hale.io.geoserver.DataStore;
import it.geosolutions.hale.io.geoserver.FeatureType;
import it.geosolutions.hale.io.geoserver.Layer;
import it.geosolutions.hale.io.geoserver.Namespace;
 ...
 * <code>it.geosolutions.hale.io.appschema.mapping</code> , only the mapping
 * file is written.
 * <p>
 * If content type is set to
 * <code>it.geosolutions.hale.io.appschema.archive</code>, a ZIP archive
...
public class AppSchemaMappingFileWriter extends AbstractAppSchemaConfigurator {
	...
	/**
	 * @see it.geosolutions.hale.io.appschema.writer.AbstractAppSchemaConfigurator#handleMapping(eu.esdihumboldt.hale.common.core.io.ProgressIndicator,
