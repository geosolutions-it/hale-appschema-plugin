...
public class DataStoreFileManager extends AbstractResourceManager<DataStoreFile> {
	...
	/**
	 * @see it.geosolutions.hale.io.geoserver.rest.AbstractResourceManager#list()
	 */
	@Override
	...
	/**
	 * @see it.geosolutions.hale.io.geoserver.rest.AbstractResourceManager#read(java.util.Map)
	 */
	@Override
	...
	/**
	 * @see it.geosolutions.hale.io.geoserver.rest.AbstractResourceManager#getFormat()
	 */
	@Override
	...
	/**
	 * @see it.geosolutions.hale.io.geoserver.rest.AbstractResourceManager#getResourceListPath()
	 */
	@Override
	...
	/**
	 * @see it.geosolutions.hale.io.geoserver.rest.AbstractResourceManager#getResourcePath()
	 */
	@Override
