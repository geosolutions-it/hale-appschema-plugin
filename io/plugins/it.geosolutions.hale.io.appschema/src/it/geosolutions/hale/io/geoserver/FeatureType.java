...
public class FeatureType extends AbstractResource {
	...
	private static final String TEMPLATE_LOCATION = "/it/geosolutions/hale/io/geoserver/template/data/featuretype-template.vm";
	...
	/**
	 * @see it.geosolutions.hale.io.geoserver.AbstractResource#templateLocation()
	 */
	@Override
